...
function gotResult(error, results) {
    if(error){
        ...
        if(results[0].label == "Barking"){
            img.src = "https://media1.giphy.com/media/m9pQ6KapT7Cq3DQ5DZ/200w.gif?cid=6c09b952v64jhnrzc2t7jhheog3oml28isvkujhkjqdzf7k0&rid=200w.gif&ct=g";
            dog = dog+1;
            document.getElementById("detected").innerHTML = "Detected Dog - "+ dog;
        }
        else if(results[0].label == "Meowing"){
            img.src = "https://media.tenor.com/w0Rv_cu3bJAAAAAM/kitty-cute.gifhttps://media.tenor.com/w0Rv_cu3bJAAAAAM/kitty-cute.gif";
            cat = cat+1;
            document.getElementById("detected").innerHTML = "Detected Cat - "+ cat;
        }
        else if(results[0].label == "Roar"){
            img.src = "https://www.google.com/url?sa=i&url=https%3A%2F%2Ftenor.com%2Fsearch%2Flion-gifs&psig=AOvVaw2wGOFPUM7p0H1yKlobwC3l&ust=1682066904360000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCNCFhdWJuP4CFQAAAAAdAAAAABAE";
            lion = lion+1;
            document.getElementById("detected").innerHTML = "Detected Lion - "+ lion;
        }
        else if(results[0].label == "Mooing"){
            img.src = "https://www.google.com/url?sa=i&url=https%3A%2F%2Ftenor.com%2Fsearch%2Fcow-moo-gifs&psig=AOvVaw3cH-DjkQGWJ322QN1JqZnw&ust=1682066939278000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCMiN7OWJuP4CFQAAAAAdAAAAABBJ";
            cow = cow+1;
